...
class HX_Dataset(data.Dataset):
    ...
    def __init__(self, infos, config, data_augmentation=True, train=False):
        super(HX_Dataset, self).__init__()
        # information of data
        self.infos = infos
        # root dir
        self.base_dir = config.root
